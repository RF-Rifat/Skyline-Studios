    ...
    <>
      ...
      >
        <span className="absolute right-0 pr-4 duration-200 ease-out group-hover:">
          <div className="bg-[#FFFF00] p-2 rounded-full group-hover:scale-0 duration-200 ease-out">
            <svg
        ...
        <span className="absolute left-4 -transl group-hover:translate-x-0 ease-out duration-200">
          <div className="bg-[#FFFF00] p-2 rounded-full">
            <svg
              className="w-6 h-6 -rotate-45"
              fill="none"
              stroke="currentColor"
        ...
        <span className="relative w-full text-left transition-colors duration-200 ease-in-out  bg-[#FFFF00] rounded-full px-4 py-2 text-xl">
          {text}
        </span>
      </Link>
    </>
