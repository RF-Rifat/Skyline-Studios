    ...
    <>
      <div className="max-w-[1440px] mx-auto relative pb-20 xl:px-10">
        <img
          ...
          alt=""
        ></img>
        <h1 className="px-6 font-bold text-5xl lg:text-6xl xl:text-7xl py-24">
          What <span className="text-gray-500">Makes Us</span> <br />
          Different <span className="text-gray-500">from Others</span>
        </h1>

        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
          <div className="p-4">
            <HiOutlineUserGroup className="h-10 w-10" />
            <h3 className="text-2xl font-semibold mb-2">User-centric Core</h3>
            <p className="text-gray-500 text-base">
              People are first, always. We immerse ourselves in your users&apos;
              perspectives, shaping designs that resonate and drive meaningful
              interactions.
            </p>
          </div>
          <div className="p-4">
            ...
            <p className="text-gray-500 text-base">
              Our skilled designers bring diverse expertise, ensuring a holistic
              approach to every project for superior results.
            </p>
          </div>
          <div className="p-4">
            <svg
            ...
            <p className="text-gray-500 text-base">
              We don&apos;t merely follow trends; rather, we help to define
              them. Our designs are driven by insights, which results in
